 ...
 * @author 50496
 */
public class musicaedito extends javax.swing.JFrame {

    /**
     * Creates new form musicaedito
     */
    buscarcodigo op = new buscarcodigo();
    ...
    private void initComponents() {
        ...
        jLabel6.setText("EDITAR EVENTO MUSICAL");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(320, 10, 320, 32);
        ...
        jPanel1.add(cambio);
        cambio.setBounds(830, 560, 112, 116);
    ...
    private void cambioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cambioActionPerformed
        ...
        editarmusica musa = new editarmusica("s", user, code, titulos, descripcion, fecha, personas, monto, totalid, "s", tipo, orq);

        if (personas <= 25000) {
            if (musa.comprobar(code) == true) {
                musa.editar(user, codigo, code, titulos, descripcion, fecha, personas, monto, totalid, tipo, orq);
                new menuevento().setVisible(true);
                this.dispose();

            } else if (codigo.equals(code)) {
                musa.editar(user, codigo, code, titulos, descripcion, fecha, personas, monto, totalid, tipo, orq);
                new menuevento().setVisible(true);
                this.dispose();

            } else {
                JOptionPane.showMessageDialog(this, "CODIGO YA UTILIZADO");
            }
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(musicaedito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new musicaedito().setVisible(true);
            }
        });
    }
