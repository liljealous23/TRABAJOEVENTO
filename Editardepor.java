 ...
 * @author 50496
 */
public class Editardepor extends javax.swing.JFrame {

    /**
     * Creates new form Editardepor
     */
    ...
    private void initComponents() {
        ...
        jLabel6.setText("EDITAR EVENTO DEPORTIVO");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(370, 10, 350, 32);
    ...
    private void guardardeporActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardardeporActionPerformed
        ...
        Editardeportec musa = new Editardeportec("s", user, code, titulos, descripcion, fecha1, personas, monto, totalid, Estado, tipo, equipo11, equipo22, nombres11, nombres22);

        if (personas <= 20000) {
            if (musa.comprobar(code) == true) {
                musa.editar(user, codigo, code, titulos, descripcion, fecha1, personas, monto, totalid, tipo, equipo11, equipo22, nombres11, nombres22);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Editardepor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
