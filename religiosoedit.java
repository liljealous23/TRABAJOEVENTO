 ...
 * @author 50496
 */
public class religiosoedit extends javax.swing.JFrame {

    buscarcodigo op = new buscarcodigo();

    /**
     * Creates new form religiosoedit
     */
    public religiosoedit() {
        initComponents();
        llenar();
    }
    ...
    private void cambioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cambioActionPerformed
        ...
        if (personas <= 30000) {
            if (reli.comprobar(code) == true) {
                ...
                reli.editar(user, codigo, code, titulos, descripcion, fecha, personas, monto, totalid, convertidas);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(religiosoedit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
