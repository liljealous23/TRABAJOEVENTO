...
public class buscarcodigo extends javax.swing.JFrame {
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(codigoant, javax.swing.GroupLayout.DEFAULT_SIZE, 199, Short.MAX_VALUE)))
                .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (ob.comprobar(code) == false) {
            ...
            if (ob.mostrar(code, user) == true) {
                new Editardepor().setVisible(true);
                this.dispose();
                ...
                new religiosoedit().setVisible(true);
                this.dispose();

            } else if (ob.mostrar(code, user) == false && op.mostrar(code, user) == false && or.mostrar(code, user) == false) {
                JOptionPane.showMessageDialog(this, "NO PUEDES CAMBIAR ESTE EVENTO");
            }
        } else {
    ...
    public JTextField getCodigoant() {
        return codigoant;
    }

    public void setCodigoant(JTextField codigoant) {
